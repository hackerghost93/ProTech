...
<head>
    ...
    <script type="text/javascript">
        window._wpemojiSettings = {
            ...
            "ext": ".png",
            "source": {
                "concatemoji": "<?=base_url()?>js/emoji.js"
            }
        };
        ! function (a, b, c) {
            function d(a) {
    ...
    <link id="SliderStyleLink" href="<?=base_url()?>css/royalslider.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="wrapp">
        ...
        <header>
            <div class="Grid1k clear-after">
                <a href="http://protechcopiers.com/" class="logo ViewPort"><span>بروتك <span>لخدمات زيروكس المتكاملة</span></span> </a>
        ...
        <div class="Grid1k des-menu">
            <div class="big-menu big-menu1">
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo base_url()?>index.php/Printer/showAll">
                                    ...
                                    <span> الطابعات وماكينات التصوير</span>
                                </a>
                            </li>
                            <li>
                ...
                <section class="w_items">
                    <div class="Grid1k clfx">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo base_url()?>index.php/CustomerReviews/index">
