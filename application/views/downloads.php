<?php $this->load->view('myHeader'); ?>
        ...
        <div class="Grid1k clfx">
            <ul>
                ...
                <?php foreach($results as $object):?>
                    <?php if($this->router->fetch_method() == 'PDFGet'){?>
                        <li>
                            <a href="<?=$object->PDF_URL?>">
                                <i><img src="<?=base_url()?>imgs/Downloads-icon.png" alt=""></i>
                                <span><?=$object->PDF_Title?></span>
                            </a>
                        </li>
                        <?php }else{?>
                            <li>
                                <a href="<?=$object->Driver_URL?>">
                                    <i><img src="<?=base_url()?>imgs/Downloads-icon.png" alt=""></i>
                                    <span><?=$object->Driver_Title?></span>
                                </a>
                            </li>
                            <?php } ?>
    ...
    <script type='text/javascript'>
        /* <![CDATA[ */
        var _wpcf7 = {
            "loaderUrl": "<?=base_url()?>imgs/ajax-loader.gif",
