<?php $this->load->view('myHeader'); ?>
    ...
    <div class="page_nav contact-page">
        <div class="Grid1k">
            ...
            <img width="414" height="289" src="<?=image_url()?>premium.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""  sizes="(max-width: 414px) 100vw, 414px" /></i>
	...
	foreach($CustomerReviews as $key){
		...
		<i class="fa fa-star" aria-hidden="true"></i>5
          ...
          <span id="bar-five" class="bar">
            <span><?php  echo $key->general_contact; ?></span>&nbsp;
                                    </span>
                                    </span>
                                </div>
          ...
          <span id="bar-four" class="bar">
            <span><?php  echo $key->general_elasticity; ?></span>&nbsp;
                                    </span>
                                    </span>
                                </div>
...
<i class="fa fa-star" aria-hidden="true"></i>3
          ...
          <span id="bar-three" class="bar">
            <span><?php  echo $key->general_care; ?></span>&nbsp;
                                    </span>
                                    </span>
                                </div>
...
<i class="fa fa-star" aria-hidden="true"></i>2
          ...
          <span id="bar-two" class="bar">
            <span><?php  echo $key->engineer_look; ?></span>&nbsp;
                                    </span>
                                    </span>
                                </div>
...
<i class="fa fa-star" aria-hidden="true"></i>1
          ...
          <span id="bar-one" class="bar">
            <span><?php  echo $key->engineer_behavior; ?></span>&nbsp;
                                    </span>
                                    </span>
                                </div>
                                <div class="one histo-rate">
...
<i class="fa fa-star" aria-hidden="true"></i>1
                                    ...
                                    <span class="bar-block">
          <span id="bar-one" class="bar">
            <span><?php  echo $key->service_speed; ?></span>&nbsp;
                                    </span>
                                    </span>
                                </div>
                                <div class="one histo-rate">
...
<i class="fa fa-star" aria-hidden="true"></i>1
                                    ...
                                    <span class="bar-block">
          <span id="bar-one" class="bar">
            <span><?php  echo $key->service_quality; ?></span>&nbsp;
                                    </span>
                                    </span>
                                </div>
                                <div class="one histo-rate">
...
<i class="fa fa-star" aria-hidden="true"></i>1
                                    ...
                                    <span class="bar-block">
          <span id="bar-one" class="bar">
            <span><?php  echo $key->service_parts; ?></span>&nbsp;
                                    </span>
                                    </span>
                                </div>
                            </div>
