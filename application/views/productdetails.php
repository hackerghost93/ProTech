            ...
            <ul class="c_post">
                ...
                <li>
                    <?php if($type == 'printer'): ?>
                        ...
                        <?php else: ?>
                            <a href="<?=base_url()?>index.php/part/showAll">المزيد من قطع الغيار</a>
                            <?php endif; ?>
                </li>
            </ul>
        </div>
        ...
        <div class="Grid1k">
            ...
            <div class="ContactArea clear-after ViewPort">
                ...
                <div class="Right clear-after">
                    ...
                    <div class="info">
                        <div>
                            <h3 class="Mobile"><?=$contact['mobile']?></h3>
                ...
                <div class="Left clear-after">
                    ...
                    <div class="info">
                        <h3 class="Email"><?=$contact['email']?></h3></div>
                </div>
            </div>
            <!-- // Contact Area -->
        </div>
