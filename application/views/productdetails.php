    ...
    <img width="404" height="440" src="<?=base_url().$product['image'][0]['image_path']?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?=$product['name']?>" sizes="(max-width: 404px) 100vw, 404px" style="height: 440px;" />
            ...
            <p><?=$product['general_description']?></p>
                <ul class="dtls-butt">
                    ...
                    <li class="dt-b2">
                        <a href="http://www.office.xerox.com/printers/color-printers/phaser-6500/eneg.html">
                            <i></i>
                            <span>شاهد الطابعه على </span>
                            <b>موقع زيروكس</b>
                        </a>
                    </li>
                </ul>
   ...
   <li>لورم ایپسوم أبجد هوز هو مجرد دمية النص</li>
    ...
    <div class="big-img-work_box"><a href="#" class="close0">X</a>
        ...
        <ul class="c_post">
            ...
            <li class="prv-work"><a href="productdetails.html">السابق</a></li>
            <li>
                 <a href="products.html">المزيد من الطابعات</a>
            </li>
            <li class="next-work"><a href="productdetails.html">التالي</a></li>

        </ul>
        <div class="share_l">
           <span>شارك هذه الطابعه</span>
                    <ul>
                        <li class="share_b1">
<a target="popup" onclick="window.open('')" class="share-butt butt_fb" title="انشر علي فيس بوك"></a>
                        </li>
                        <li class="share_b2">
<a target="popup" onclick="window.open('')" class="share-butt butt_twtt" title="غرد علي تويتر"></a>
                        </li>
                        <li class="share_b3">
<a target="popup" onclick="window.open('')" class="share-butt butt_google" title="انشر علي جوجل بلس"></a>
                        </li>
...
<a href='#' class='tag-link-26 tag-link-position-1' title='xeroex ' style='font-size: 21.8352941176pt;'>xeroex</a>
            <a href='#' class='tag-link-26 tag-link-position-2' title='xeroex ' style='font-size: 21.8352941176pt;'>طابعات</a>
            <a href='#' class='tag-link-26 tag-link-position-3' title='xeroex ' style='font-size: 21.8352941176pt;'>الوان</a>
    ...
    <section class="work-slider">
        <div class="Grid1k clfx">
            <div class="WorkSlider-Control">
                 <a href="products.html">   طابعات ذات صله</a>
            </div>
            <!-- Works -->
            <div class="WorksSlider">
                ...
                <div class="item">
                    ...
                    <div class="Work-Block">
                        <div class="img-fill">
<img width="404" height="316" src="imgs/thumbnail1-300x300.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="xeroeximg" srcset="imgs/thumbnail1-300x300.png 404w, imgs/thumbnail1-300x300.png 300w" sizes="(max-width: 404px) 100vw, 404px" />                            <a href="productdetails.html" class="info">
                               
                               <h3> طابعات زيروكس - طابعة زيروكس فازر 6500</h3></a>
                        </div>
                    </div>
                    <!-- // Work Block -->
                </div>
