...
<html lang="en">
    ...
    <body>
        ...
        <div class="OverLayForm closed chart" id="AddNewEvaluationOverlayForm">
          ...
          <form method="POST" action="<?=base_url()?>index.php/evaluation/addNew" id="AddSlideShowForm" enctype="">
                   ...
                   <div class="FormSection">
                       ...
                       <div class="SectionContent row">
                         <div class="form-group formLayout col-md-6">
                            ...
                            <input type="date" name="evaluation_date" class="form-control" placeholder=" التاريخ" />
                        </div>
					   <div class="form-group formLayout col-md-6">
...
<<<<<<< HEAD
                            <input type="radio" name="general_care" id="optionsRadios2" value="Excellent" >
                               <label class="dataradio">  ممتاز   </label><br>
                               <input type="radio" name="general_care" id="optionsRadios3" value="verygood" >
                               <label class="dataradio">  جيد جدا   </label><br>
                             <input type="radio" name="general_care" id="optionsRadios4" value="good" >
                               <label class="dataradio">  جيد </label><br>
                              <input type="radio" name="general_care" id="optionsRadios5" value="accepted" >
                               <label class="dataradio">  مقبول </label><br>
                               <input type="radio" name="general_care" id="optionsRadios6" value="bad" >
=======
...
<<<<<<< HEAD
                            <input type="radio" name="general_elasticity" id="optionsRadios7" value="Excellent" >
                               <label class="dataradio">  ممتاز   </label><br>
                               <input type="radio" name="general_elasticity" id="optionsRadios8" value="verygood" >
                               <label class="dataradio">  جيد جدا   </label><br>
                             <input type="radio" name="general_elasticity" id="optionsRadios9" value="good" >
                               <label class="dataradio">  جيد </label><br>
                              <input type="radio" name="general_elasticity" id="optionsRadios10" value="accepted" >
                               <label class="dataradio">  مقبول </label><br>
                               <input type="radio" name="general_elasticity" id="optionsRadios11" value="bad" >
=======
...
<<<<<<< HEAD
                            <input type="radio" name="general_contact" id="optionsRadios12" value="Excellent" >
                               <label class="dataradio">  ممتاز   </label><br>
                               <input type="radio" name="general_contact" id="optionsRadios13" value="verygood" >
                               <label class="dataradio">  جيد جدا   </label><br>
                             <input type="radio" name="general_contact" id="optionsRadios14" value="good" >
                               <label class="dataradio">  جيد </label><br>
                              <input type="radio" name="general_contact" id="optionsRadios15" value="accepted" >
                               <label class="dataradio">  مقبول </label><br>
                               <input type="radio" name="general_contact" id="optionsRadios16" value="bad" >
=======
...
<<<<<<< HEAD
                            <input type="radio" name="engineer_behavior" id="optionsRadios17" value="Excellent" >
                               <label class="dataradio">  ممتاز   </label><br>
                               <input type="radio" name="engineer_behavior" id="optionsRadios18" value="verygood" >
                               <label class="dataradio">  جيد جدا   </label><br>
                             <input type="radio" name="engineer_behavior" id="optionsRadios19" value="good" >
                               <label class="dataradio">  جيد </label><br>
                              <input type="radio" name="engineer_behavior" id="optionsRadios20" value="accepted" >
                               <label class="dataradio">  مقبول </label><br>
                               <input type="radio" name="engineer_behavior" id="optionsRadios21" value="bad" >
=======
...
<<<<<<< HEAD
                            <input type="radio" name="engineer_look" id="optionsRadios22" value="Excellent" >
                               <label class="dataradio">  ممتاز   </label><br>
                               <input type="radio" name="engineer_look" id="optionsRadios23" value="verygood" >
                               <label class="dataradio">  جيد جدا   </label><br>
                             <input type="radio" name="engineer_look" id="optionsRadios24" value="good" >
                               <label class="dataradio">  جيد </label><br>
                              <input type="radio" name="engineer_look" id="optionsRadios25" value="accepted" >
                               <label class="dataradio">  مقبول </label><br>
                               <input type="radio" name="engineer_look" id="optionsRadios26" value="bad" >
=======
...
<<<<<<< HEAD
                            <input type="radio" name="service_parts" id="optionsRadios27" value="Excellent" >
                               <label class="dataradio">  ممتاز   </label><br>
                               <input type="radio" name="service_parts" id="optionsRadios28" value="verygood" >
                               <label class="dataradio">  جيد جدا   </label><br>
                             <input type="radio" name="service_parts" id="optionsRadios29" value="good" >
                               <label class="dataradio">  جيد </label><br>
                              <input type="radio" name="service_parts" id="optionsRadios30" value="accepted" >
                               <label class="dataradio">  مقبول </label><br>
                               <input type="radio" name="service_parts" id="optionsRadios31" value="bad" >
=======
...
<<<<<<< HEAD
                            <input type="radio" name="service_quality" id="optionsRadios32" value="Excellent" >
                               <label class="dataradio">  ممتاز   </label><br>
                               <input type="radio" name="service_quality" id="optionsRadios33" value="verygood" >
                               <label class="dataradio">  جيد جدا   </label><br>
                             <input type="radio" name="service_quality" id="optionsRadios34" value="good" >
                               <label class="dataradio">  جيد </label><br>
                              <input type="radio" name="service_quality" id="optionsRadios35" value="accepted" >
                               <label class="dataradio">  مقبول </label><br>
                               <input type="radio" name="service_quality" id="optionsRadios36" value="bad" >
=======
...
<<<<<<< HEAD
                            <input type="radio" name="service_speed" id="optionsRadios37" value="Excellent" >
                               <label class="dataradio">  ممتاز   </label><br>
                               <input type="radio" name="service_speed" id="optionsRadios38" value="verygood" >
                               <label class="dataradio">  جيد جدا   </label><br>
                             <input type="radio" name="service_speed" id="optionsRadios39" value="good" >
                               <label class="dataradio">  جيد </label><br>
                              <input type="radio" name="service_speed" id="optionsRadios40" value="accepted" >
                               <label class="dataradio">  مقبول </label><br>
                               <input type="radio" name="service_speed" id="optionsRadios41" value="bad" >
=======
...
>>>>>>> origin/master
                      ...
                      <div class="FormSection">
                       ...
                       <div class="SectionContent row">
                             <div class="form-group formLayout col-md-6">
                            <label for="commenter_phone" class="control-label ">رقم الهاتف : </label>
                            <input type="text" name="commenter_phone" class="form-control" placeholder=" رقم الهاتف" />
                        </div>
					      <div class="form-group formLayout col-md-6">
                            <label for="commenter_name" class="control-label ">الإسم : </label>
                            <input type="text" name="commenter_name" class="form-control" placeholder=" إسم العميل" />
                        </div>
                      
                           <div class="col-md-6"></div>
                      <div class="form-group formLayout col-md-6">
                            <label for="comment" class="control-label ">الملاحظة: </label>
                            <textarea name="comment" col="50"></textarea>
                        </div>
