<?php $this->load->view('myHeader') ;  ?>
    ...
    <div id="example1" class="slider-pro" style="background:hsla(0, 0%, 80%, 0.54);">
        <div class="sp-slides">
            <!-- here-->
            <?php foreach($slides as $slide):?>
                <div class="sp-slide">
                    <img class="sp-image" src="imgs/blank.gif" data-src="<?=base_url().$slide['Slide_image']?>" data-retina="<?=base_url().$slide['Slide_image']?>" />
                </div>
                <?php endforeach; ?>
        </div>
                                    ...
                                    <div class="Work-Block">
                                        <div class="img-fill">
                                            <?php if(isset($printer['images'][0]['image_path'])): ?>
                                                <img width="404" height="316" src="<?=base_url().$printer['images'][0]['image_path']?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="printerImg" sizes="(max-width: 404px) 100vw, 404px" />
                                                <div class="info">
                                                    <h3><?=$printer['name']?></h3></div>
                                                <?php else: ?>
                        ...
                        <div class="Section07" id="sec7">
                            <div class="Grid1k">
                                ...
                                <div class="Section-Head ViewPort">
                                    ...
                                    <p>تضع شركة بروتك في راس جدول إعتباراتها أمن وأموال عملائها، وكذلك نحن نفتخر بكوننا نقدم أفضل خدمة للعملاء.</p>
                                </div>
                                <!-- // Section Head -->
                            ...
                            <div class="Section08">
                                <div class="Grid1k">
                                    ...
                                    <div class="Section-Head ViewPort">
                                        ...
                                        <p>
                                            تأسست شركة بروتك عام 2008 وتعد من اول الشركات الرائدة المتخصصة فى مجال توريد وصيانة ماكينات التصوير XEROX بمحافظة الاسكندرية وبعض المحافظات الاخرى</p>
                                    </div>
                                    <!-- // Section Head -->
                                    ...
                                    <div class="Elnoor-I clear-after ViewPort">
                                        ...
                                        <div class="Elnoor-Block">
                                            ...
                                            <h3>وتضم فريق عمل من ذوى الخبرات الممتازة القادرة على تقديم افضل خدمات الصيانة والتوريد مع اعلى مستوى من الخدمة</h3>
                                        </div>
                                        <!-- // Item -->
                                        <!-- Right -->
                                        <div class="Right-Blocks">
                                            ...
                                            <div class="Elnoor-Block">
                                                <img src="<?=base_url()?>imgs/icon19.png" alt="">
                                                <h3>قطع الغيار ومستلزمات التشغيل :تتوافر لدى الشركة جميع قطع غيار ومستلزمات تشغيل جميع ماكينات التصوير زيروكس بأسعار منافسة </h3>
                                            </div>
                                            <!-- // Item -->
                                            <!-- Item -->
                                            <div class="Elnoor-Block">
                                                <img src="<?=base_url()?>imgs/icon19.png" alt="">
                                                <h3>الايجـــــار :تقوم الشركة بتوفير افضل الاكينات لعقود الايجار حسب اختيار واحتياج العميل مقابل عقد ( شهرى – ربع سنوى – نصف سنوى – سنوى )</h3>
                                            </div>
                                            <!-- // Item -->
                                        </div>
                                        <!-- // Right -->
                                        ...
                                        <div class="Left-Blocks">
                                            ...
                                            <div class="Elnoor-Block">
                                                <img src="<?=base_url()?>imgs/icon19.png" alt="">
                                                <h3>الصيانة  :تقوم الشركة بتقديم كافة نماذج الصيانة التى تناسب كل عميل على حدة</h3>
                                            </div>
                                            <!-- // Item -->
                                            <!-- Item -->
                                            <div class="Elnoor-Block">
                                                <img src="<?=base_url()?>imgs/icon19.png" alt="">
                                                <h3>الأستبدال :امكانية استبدال الماكينات القديمة بأخرى جديدة حسب اختيار واحتياج العميل</h3>
                                            </div>
                                            <!-- // Item -->
                                        </div>
                                        <!-- // Left -->
                                        ...
                                        <div class="Elnoor-Block">
                                            <img src="<?=base_url()?>imgs/icon19.png" alt="">
                                            <h3>البيع:تتوفر لدينا اكبر تشكيلة متنوعة من ماكينات التصوير زيروكس بمختلف الاحجام والامكانيات استيراد الخارج وبطرق سداد متنوعة وتوريد جيع مستلزمات التشغيل وقطع الغيار</h3>
                                        </div>
                                        <!-- // Item -->
                                    </div>
                                    <!-- // Elnoor Online -->
